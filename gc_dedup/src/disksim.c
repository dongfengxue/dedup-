...
fprintf (outputfile,"disksim_checkpoint: simtime %f, totalreqs %d\n", simtime, disksim->totalreqs);  //add byl hj
...
{
	//Î²ÑÓ³Ù¼ÆËã	 add bylhj
	
		FILE *outputfile_time=fopen("offline_time.txt","w");
		int i;
		float time=0.0;
		int sum=0;
		int sum_r=0;
