...
//	printf("intr_request start! curr-type=%d\n",curr->type);
...
//   printf("intr_request end!   intrp->time=%lf,intrp->type=%d,simtime=%lf,curr->time=%lf\n",intrp->time,intrp->type,simtime,curr->time);
}
