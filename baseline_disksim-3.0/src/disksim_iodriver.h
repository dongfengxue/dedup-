...
/*edit by lhj 原版都是0*/
#define IODRIVER_IMMEDSCHED_TIME		0.02
#define IODRIVER_WRITE_DISCONNECT_TIME		0.02
#define IODRIVER_READ_DISCONNECT_TIME		0.02
#define IODRIVER_RECONNECT_TIME			0.02
#define IODRIVER_BASE_COMPLETION_TIME		0.02

#define IODRIVER_COMPLETION_RESPTODEV_TIME	0.01
#define IODRIVER_COMPLETION_RESPTOSCHED_TIME	0.01
#define IODRIVER_COMPLETION_SCHEDTOEND_TIME	0.01
#define IODRIVER_COMPLETION_SCHEDTOWAKEUP_TIME	0.01
#define IODRIVER_COMPLETION_WAKEUPTOEND_TIME	0.01
#define IODRIVER_COMPLETION_RESPTOWAKEUP_TIME	0.01
#define IODRIVER_COMPLETION_RESPTOREQ_TIME	0.01    /* e.g., Software RAID */
...
typedef struct iodriver {
   ...
   double	scale;
   int		numdevices;           //device 的数量
   int		numctlrs;          //ctrl 的数量
   struct ioq *	queue;
   device *	devices;
   ctlr *	ctlrs;
   char        *name;
